...
class Agent(object):
	...
	def sonorizationLenition(self, trigram):
		...
		if isEnd and trigram[2] == "/":
			return
		# if trigram[focus] == u'g': #hacky
		# 	# print "ERROR: " + str(trigram)
	...
	def affrication(self, trigram, loc):
		# print IPAToInternal[trigram[loc]]
		# print InternalToIPA[IPAToInternal[trigram[loc]]+100]
	...
	def debuccalization(self, trigram, loc):
		# if IPAToInternal[trigram[loc]] - math.floor(IPAToInternal[trigram[loc]]) == 0:
